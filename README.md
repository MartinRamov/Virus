...
Податоците се зачувуваат во текстуална датотека во AppData и не се бришат по затварање на апликацијата.
...
###2.5 Паузирање/продолжување на играта

Откако при клик на *New Game* ќе започне новата игра, со притискање (KeyDown) на копчето п (p) од тастатурата се активира настанот за паузирање/продолжување на играта. Доколку играта е активна, со овој настан се овозможува паузирање на играта, а во спротивно се прекинува паузата и се продолжува со играње.
