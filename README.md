...
По завршување на секоја игра добивате дијалог прозорец со три копчиња. На копчето Save my score единствено го зачувувате вашиот постигнат резултат, а потоа одбирате Retry за нова игра или Cancel со што се враќате на почетното мени.</br>
...
На секоја класа, функција и промелива и е доделен xml summary  кој јасно ја опишува нивната функција и примена.</br>
</ol>
<p align="center">
