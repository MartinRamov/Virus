...
###3.2 Функции
####3.2.1 Има два тајмери од кои едниот го тригерира настанот за додавање на нов карактер и за промена за индикаторот. Другиот се користи за придвижувањето и исцртувањето на карактерите.
####3.2.2 Клик настан
